/** 25 joints x 2 hands x xyz, written each frame while hand tracking is active. */
export const localHandJoints = new Float32Array(150);
export const localHandTracked: [boolean, boolean] = [false, false];
